...
class AIService {
  constructor() {
    ...
    if (this.provider === 'gemini' && !this.gemini) {
      console.error('❌ ERROR: AI_PROVIDER is set to "gemini" but GEMINI_API_KEY is not configured!');
      console.error('📝 Add GEMINI_API_KEY to your .env file');
      console.error('🔗 Get free key at: https://makersuite.google.com/app/apikey');
    } else if (this.provider === 'openai' && !this.openai) {
      console.error('❌ ERROR: AI_PROVIDER is set to "openai" but OPENAI_API_KEY is not configured!');
    }
  }
